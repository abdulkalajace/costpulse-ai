...
export const VendorsView: React.FC<VendorsViewProps> = ({
  ...
  const departments = ['ALL', 'Core Platform Engineering', 'Global Sales & Revenue', 'Operations & Real Estate', 'Marketing'];
      ...
      <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-2xs">
          ...
          <div className="mt-2 text-[11px] text-rose-600 font-medium">
            Salesforce (+18%) and Zoom (+12%) contract escalations
          </div>
        </div>

        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-2xs">
          <div className="text-xs text-slate-500 font-medium">Auto-Renewal Notice Windows</div>
          <div className="mt-2 text-2xl font-bold text-indigo-700 tracking-tight">
            45 Days
          </div>
          <div className="mt-2 text-[11px] text-slate-500">
            Average cancellation notice required
          </div>
        </div>
      </div>
